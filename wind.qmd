...
Create simulated data (n = 100) based on NORA3 hourly data. Simulated data follow a Weibull distribution with the same global shape but mean values of the hourly data.
...
sim_wind_100m |> 
  ...
  geom_histogram(aes(y =..density..),
                 ...
                 colour = "grey") +
  geom_density() +
  labs(title = "Wind distribution in similated data",
...
Analise variability in the data.
